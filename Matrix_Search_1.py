...
def matrix_searcher(amount_var, n, control_lst_dom_):
    for x_8 in range(n):
        for x_10 in range(n):
            for x_11 in range(n):
...
def main():
    ...
    print(timed(matrix_searcher, amount, N, control_lst_dom))
    print("\n")

    print("matrix_searcher result: ")
    print(matrix_searcher(amount, N, control_lst_dom))
...
# print("matrix_searcher result: ")
# print(matrix_searcher(amount, N))
